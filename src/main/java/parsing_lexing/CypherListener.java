...
public interface CypherListener extends ParseTreeListener {
	...
	/**
     * Enter a parse tree produced by {@link CypherParser#returnMain}.
     *
     * @param ctx the parse tree
	 */
    void enterReturnMain(CypherParser.ReturnMainContext ctx);

	/**
     * Exit a parse tree produced by {@link CypherParser#returnMain}.
     *
     * @param ctx the parse tree
	 */
    void exitReturnMain(CypherParser.ReturnMainContext ctx);
