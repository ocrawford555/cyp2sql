...
public class Cyp2SQL_v2_Apoc {
    ...
    private static void getLabelMapping() {
        ...
        FileInputStream fis;
        try {
            fis = new FileInputStream(Cyp2SQL_v2_Apoc.workspaceArea + "/meta_labels.txt");
            ...
            fis = new FileInputStream(Cyp2SQL_v2_Apoc.workspaceArea + "/meta_rels.txt");
